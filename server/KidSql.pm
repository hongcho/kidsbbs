...
# == TODO
# - Check for deleted/re-arranged sequence...
######################################################################
...
use lib '/home1/soriorg/perlmod/usr/lib64/perl5/5.8.8/x86_64-linux-thread-multi';
...
my $DOC_DIR = $ENV{HOME}.'/public_html/kidsbbs';
my $BIN_DIR = $DOC_DIR;

my $AGENT_STRBASE = 'KidSqlGet 0/1 (http://sori.org/kidsbbs) ';
...
my $mysql_user = 'soriorg_kidsbbs';
my $mysql_passwd = '12votmdnjem';
my $mysql_db = 'soriorg_kidsbbs';
